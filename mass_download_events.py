...
if __name__ == '__main__':
    ...
    sta_range: 
        domain type:0 (RectangularDomain) sta_range = [sta_lat_min, sta_lat_max, sta_lon_min, sta_lon_max] in degree
                       if limit_distance=True, add distance restriction to the Rectangular domain
                      (RestrictionDomain) [min_dis, max_dis] in degree 
        domain type:1 (CircularDomain) sta_range = [minradius, maxradius] in degree 
